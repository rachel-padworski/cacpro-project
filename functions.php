...
{ 
	if (!is_admin()) 
	{
        ...
        wp_enqueue_script('swiper-js', get_bloginfo('stylesheet_directory').'/js/swiper.js', array(), '1.0', true);
        
        
        wp_enqueue_style('swiper-style', get_bloginfo('stylesheet_directory').'/scss/_swiper.scss');	
